  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        autoComplete="off"
        className="w-full rounded-lg border border-border bg-surface px-3 py-2 text-base sm:text-sm placeholder:text-foreground/50 focus:border-accent focus:outline-none"
      />
      {value && (
